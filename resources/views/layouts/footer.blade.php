<footer class="bg-gray-800 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <h3 class="text-lg font-bold mb-4">PrintMarket</h3>
                <p class="text-gray-300 mb-4">The leading marketplace for printing services in Egypt.</p>
        ...
        <div class="mt-8 pt-8 border-t border-gray-700">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-4 md:mb-0">
                    <p>&copy; {{ date('Y') }} PrintMarket. All rights reserved.</p>
                </div>
                <div class="flex space-x-6">
                    <a href="{{ route('terms') }}" class="text-gray-300 hover:text-white">Terms of Service</a>
                    <a href="{{ route('privacy') }}" class="text-gray-300 hover:text-white">Privacy Policy</a>
                    <a href="{{ route('cookies') }}" class="text-gray-300 hover:text-white">Cookie Policy</a>
                </div>
            </div>
        </div>
    </div>
